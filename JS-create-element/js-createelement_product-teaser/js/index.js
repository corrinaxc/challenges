    ...
    <div class="product__body">
      <div class="product__text-container">
        ...
        <footer class="product__footer">
          ...
          <button type="button" class="product__buy-button" data-js="new_product_buy_button">Buy</button>
        </footer>
      </article>`

  document.body.append(newProduct);

  const button = document.querySelector('[data-js="new_product_buy_button"]');
